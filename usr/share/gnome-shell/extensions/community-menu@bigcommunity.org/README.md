...
GNOME Shell 50 applications menu used by the Big Gnome Center.
...
using its own UUID, settings schema, name, and neutral artwork. Only the stock GNOME
panel and Dash to Panel are supported.
