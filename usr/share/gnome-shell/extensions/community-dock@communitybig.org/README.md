...
Community Dock is BigCommunity's bundled, layout-integrated fork of Dash to
Dock 106. See `UPSTREAM.md` for provenance and local integration policy.

# Dash to Dock upstream documentation
