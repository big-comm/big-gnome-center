...
}, class CommunityBigAppListLayout extends BaseLayout.BaseLayout {
    ...
    _loadLayout() {
        ...
        this._categoriesSection = new Sections.CategoriesListSection(
            this._appsBackend,
            {
                ...
                openCascadeOnRight: this._desktopLayout === 'desk-ux',
                inheritLightStyle: this._desktopLayout === 'desk-ux',
            });
