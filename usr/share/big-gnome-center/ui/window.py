...
class MainWindow(Adw.ApplicationWindow):
    """
    Janela principal do Big Gnome Center.
    ...
    def __init__(self, app: Adw.Application) -> None:
        ...
        # Isso garante que big-gnome-center.svg apareça na janela About
    ...
    def _build_sidebar(self) -> Gtk.Widget:
        ...
        # Centered app name
        title_lbl = Gtk.Label(label=tr("Big Gnome Center"))
    ...
    def _show_about(self) -> None:
        about = Adw.AboutDialog(
            application_name=tr("Big Gnome Center"),
