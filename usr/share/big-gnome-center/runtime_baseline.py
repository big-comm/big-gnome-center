...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    args.layouts_dir = args.layouts_dir or args.root / "usr/share/big-gnome-center/layouts"
    stamp = datetime.now().astimezone().strftime("%Y%m%d-%H%M%S")
    artifact_dir = args.artifacts or Path.home() / ".cache/big-gnome-center/baseline" / stamp
