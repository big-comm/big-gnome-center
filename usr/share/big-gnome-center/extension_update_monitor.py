...
log = logging.getLogger("big-gnome-center-extension-updates")
...
class ExtensionUpdateMonitor:
    ...
    def _open_updates() -> None:
        launcher = Path("/usr/bin/big-gnome-center")
        argv = [str(launcher) if launcher.exists() else "big-gnome-center"]
